...
#pragma unroll
      ...
      // NOTE here each thread adds its own alibi (one per head..) like I am sure not the whole group needs to do so
...
__global__ void paged_attention_v1_kernel(
  ...
  paged_attention_kernel<scalar_t, cache_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS,
      ...
      max_num_blocks_per_seq, alibi_slopes, attn_bias, q_stride, kv_block_stride,
...
__global__ void paged_attention_v2_kernel(
  ...
  paged_attention_kernel<scalar_t, cache_t, HEAD_SIZE, BLOCK_SIZE, NUM_THREADS,
      ...
      block_tables, seq_lens, max_num_blocks_per_seq, alibi_slopes, attn_bias, q_stride,
