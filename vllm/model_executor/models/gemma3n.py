...
class Gemma3nAttention(nn.Module):
    ...
    def __init__(self,
        ...
        if self.is_kv_shared:
            ...
            # TODO             kv_sharing_target_layer_name = f"language_model.model.layers.{kv_shared_layer_index}.self_attn.attn"  # noqa: E501
...
class Gemma3nTextModel(nn.Module, SupportsQuant):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__()
        # TODO config = vllm_config.model_config.hf_config
...
class Gemma3nForCausalLM(nn.Module, SupportsQuant):
